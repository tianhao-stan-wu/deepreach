...
p.add_argument('--pretrain', default=True, required=False, help='Pretrain dirichlet conditions')
...
dataset = dataio.Reachability2DExample(numpoints=65000, collisionR=opt.collisionR,
                                          speed_max=opt.speed_max, pretrain=opt.pretrain, tMin=opt.tMin,
...
# Define the loss
loss_fn = loss_functions.initialize_hji_2DExample(dataset, opt.minWith)
